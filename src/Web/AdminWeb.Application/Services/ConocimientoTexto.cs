...
/// </list>
/// <para>Todo lo demás es texto. No hay imágenes, ni tablas, ni HTML incrustado, ni forma de meter
/// un atributo en ninguna parte.</para>
///
...
public static class ConocimientoTexto
{
    ...
    /// </summary>
    public static List<ConocimientoBloqueDto> Analizar(string? cuerpo)
    {
    ...
    /// texto crudo: así el extracto no puede enseñar un <c>**</c> ni la dirección larga de un enlace
    /// cuya etiqueta era «la guía», que es lo que pasaría al limpiar la fuente a mano. Y si mañana
    /// se añade una forma al marcado, el extracto la entiende sin tocarlo.</para>
    /// </summary>
