...
public class Sprint
{
    ...
    /// <summary>
    /// Sello de concurrencia optimista. Es nuevo de la web: el sprint es una ficha que varias
    /// personas consultan y que el administrador reajusta (fechas, objetivo) mientras el líder la
    /// tiene abierta en otro navegador. Con el sello, el segundo en guardar recibe un error de
    /// concurrencia en vez de pisar en silencio lo que escribió el primero.
