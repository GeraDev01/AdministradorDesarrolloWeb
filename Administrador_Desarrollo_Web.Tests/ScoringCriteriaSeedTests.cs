...
public class ScoringCriteriaSeedTests
{
    ...
    [Fact]
    public void Migrar_RenombraYReescribeLaDescripcion()
    {
        using var db = BaseHeredada();
        var muestra = ScoringCriteriaSeed.Individuales[0];

        int cambiados = ScoringCriteriaSeed.MigrarNomenclatura(db);
    ...
    /// </summary>
    [Fact]
    public void Migrar_RespetaLaDescripcionQueEscribioElAdministrador()
    {
        using var db = BaseHeredada();
        var muestra = ScoringCriteriaSeed.Individuales[0];
    ...
    /// </summary>
    [Fact]
    public void MigrarYSembrar_NoDuplicaNada()
    {
        using var db = BaseHeredada();
    ...
    [Fact]
    public void MigrarYSembrar_EsIdempotente()
    {
        using var db = BaseHeredada();
        ...
        Assert.Equal(0, ScoringCriteriaSeed.MigrarNomenclatura(db));   // ya no queda nada que renombrar
        ScoringCriteriaSeed.Sembrar(db);
    ...
    [Fact]
    public void Sembrar_EnBaseVaciaDejaElCatalogoCompleto()
    {
    ...
    /// </summary>
    [Fact]
    public void Migrar_NoRompeLosPuntosYaOtorgados()
    {
        using var db = BaseHeredada();
    ...
    /// </summary>
    [Fact]
    public void Migrar_NoRenombraSiElNombreNuevoYaEstaOcupado()
    {
        using var db = BaseHeredada();
        var muestra = ScoringCriteriaSeed.Individuales[0];
        db.ScoringCriteria.Add(new ScoringCriterion
    ...
    [Fact]
    public void Migrar_EnBaseVaciaNoHaceNada()
    {
        using var db = TestDb.New();
        Assert.Equal(0, ScoringCriteriaSeed.MigrarNomenclatura(db));
